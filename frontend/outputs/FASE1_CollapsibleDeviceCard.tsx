                  ...
                  <div key={entity.id} className="space-y-2">
                    ...
                    {entity.hasHistory && (
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg shadow-md transition-all transform hover:scale-105"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
                        </svg>
                        {hasChart ? 'Ocultar Gráfico' : 'Ver Gráfico Histórico'}
                      </button>
                    )}

                    {/* Chart Expandido + Botão CSV */}
                    {hasChart && entity.hasHistory && (
                      <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg border-2 border-blue-200 dark:border-blue-800 space-y-3">
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg shadow-md transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          {exportingCSV ? (
                            <>
                            ...
                            <>
                              ...
                              <span>Exportar CSV (últimos 30 dias)</span>
                            </>
                          )}
                        </button>
                      </div>
